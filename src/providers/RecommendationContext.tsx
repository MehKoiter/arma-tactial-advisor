...
export function RecommendationProvider({ children }: { children: ReactNode }) {
  ...
  const secondaryList = useMemo<AnyScored[]>(() => {
    if (!tabs.secondary) return []
    if (vehicleType === 'LAV')
      return scoreAttackCandidates(
        everonCAPs,
        state,
        DEFAULT_ATTACK_CONFIG,
        notes,
    ...
    return []
  }, [tabs.secondary, state, notes, vehicleType, factionMobs])
